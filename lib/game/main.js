...
.requires(
    ...
    'game.levels.village3',
    'game.levels.village4',
...
.defines(function(){
    ...
    ig.readyScene  = 'overworld';        // the type of scene to load: overworld | level
    ig.readyLevel  = 'LevelOverworld1';  // the name of the level object
    ig.readyDoorID = 'overworld-1-a';    // the id of the door in the current scene
    ig.readyExitID = 'overworld-1-a';    // the id of the door to exit from in the next scene
    
    ig.switchScene = function() {
        console.log(ig.readyScene);
        console.log(ig.readyLevel);
        console.log(ig.readyDoorID);
        console.log(ig.readyExitID);
    ...
    ig.main('#canvas', SceneOverworld, 1, 300, 180, 3);
