...
.defines(function() {
    EntityPlayer = ig.Entity.extend({
        ...
        checkPosition: function() {
            ...
            {
                /*
                if (ig.lastOverworldScene)
                {
                    ig.playerFlip = true; // facing left
                    ig.system.setGame(ig.lastOverworldScene);
                    return;
                }
                else
                {
            ...
            else if ((this.pos.x + this.size.x) > (ig.game.collisionMap.pxWidth - ig.game.camera.offset.x.max))
            {
                ...
                if (ig.lastOverworldScene)
                {
                    ig.playerFlip = false; // facing right
                    ig.system.setGame(ig.lastOverworldScene);
                    return;
                }
                else
        ...
        checkDoor: function(other) {
            if (this.switching == false)
            {
                this.switching = true;
                ig.playerFlip = this.flip;
                
                ig.readyScene = (other.scene ? other.scene : false);
                ig.readyLevel = (other.level ? other.level : false);
                ig.switchScene();
            }
        },
